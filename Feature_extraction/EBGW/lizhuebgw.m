...
%匹配的字符串
firstmatches=findstr(string,'>')+7;%开始位置(名字长度+1）1指的是>所占一个单位
...
shuEBGW_Independent_Fertlity=[eb1,eb2,eb3];
% label1=ones(445,1);
% label2=zeros(4187,1);
% label=[label1;label2];
% shu_ebgw=[label,ebgw];
%   save neEBGW_z.mat 
% save neneEBGW_f.mat
save EBGW_Independent_Fertlity.mat shuEBGW_Independent_Fertlity
